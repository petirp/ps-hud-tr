...
<div class="text-sm flex flex-col text-[#e8e8e8]">
  <div class="mx-4 mb-5 mt-3">
    ...
    />
    <p class="text-base">SEKS YAPMAYI SEVERIM If your hud is acting up, give it a good ol' reset! Or you can do /resethud</p>
    ...
    <p class="text-base">SEKS GUZEL BIR SEY ! If you want to reset your settings back to default; click this shiny button!</p>
